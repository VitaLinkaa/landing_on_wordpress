<?php
  ...
  add_action( 'wp_enqueue_scripts', 'timber_scripts' );
    ...
    function timber_style(){
      wp_enqueue_style('normalize-style', get_template_directory_uri() . '/assets/css/main.css');
      wp_enqueue_style('all-style', get_template_directory_uri() . '/assets/css/all.min.css');
      wp_enqueue_style('animate-style', get_template_directory_uri() . '/assets/css/animate.min.css');
      wp_enqueue_style('fontawesome-style', get_template_directory_uri() . '/assets/css/fontawesome.min.css');
    ...
    function timber_scripts(){
      ...
      wp_enqueue_script('progress-script', get_template_directory_uri() . '/assets/js/progress.js', array(), null, true);
